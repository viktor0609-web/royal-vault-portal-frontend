        ...
        <Table className="w-full min-w-max">
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-96 min-w-96">Description</TableHead>
              <TableHead className="w-48 min-w-48">Video URL</TableHead>
              <TableHead className="w-48 min-w-48">PDF URL</TableHead>
