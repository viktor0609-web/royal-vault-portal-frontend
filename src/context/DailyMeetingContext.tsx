...
export const DailyMeetingProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const startRecording = async () => {
    ...
    try {
      ...
      //       "videoSettings.dominant.followDomFlag": true,
      ...
      //       "text.color": "rgba(255, 250, 200, 0.95)",
      //       "text.strokeColor": "rgba(0, 0, 0, 0.8)",
      //       "text.stroke_gu": 0.5,
      //       "text.highlight.color": "rgba(255, 255, 0, 1)",
      //       "text.highlight.fontWeight": "700",
      ...
      //       "webFrame.fullScreen": false,
      //       "webFrame.height_gu": 12,
      //       "webFrame.margin_gu": 1.5,
      //       "webFrame.opacity": 1,
      //       "webFrame.enableFade": true,
      //       "webFrame.keyPress.keyName": "ArrowRight",
      //       "webFrame.keyPress.modifiers": "",
      //       "webFrame.keyPress.key": 0,
      //       "banner.title": "Hello world",
      //       "banner.subtitle": "This is an example subtitle",
      //       "banner.source": "param",
      //       "banner.enableTransition": true,
      //       "banner.margin_x_gu": 0,
      //       "banner.margin_y_gu": 1,
      //       "banner.padding_gu": 2,
      //       "banner.alwaysUseMaxW": false,
      //       "banner.maxW_pct_default": 65,
      //       "banner.maxW_pct_portrait": 90,
      //       "banner.rotation_deg": 0,
      //       "banner.cornerRadius_gu": 0,
      //       "banner.showIcon": true,
      //       "banner.icon.assetName": "",
      //       "banner.icon.emoji": "🎉",
      //       "banner.icon.size_gu": 3,
      //       "banner.color": "rgba(50, 60, 200, 0.9)",
      //       "banner.strokeColor": "rgba(0, 0, 30, 0.44)",
      //       "banner.stroke_gu": 0,
      //       "banner.text.color": "white",
      //       "banner.text.strokeColor": "rgba(0, 0, 0, 0.1)",
      //       "banner.text.stroke_gu": 0.5,
      //       "banner.text.fontFamily": "Roboto",
      //       "banner.title.fontSize_gu": 2,
      //       "banner.title.fontWeight": "500",
      //       "banner.title.fontStyle": "",
      //       "banner.subtitle.fontSize_gu": 1.5,
      //       "banner.subtitle.fontWeight": "300",
      //       "banner.subtitle.fontStyle": "",
      //       "toast.key": 0,
      //       "toast.text": "Hello world",
      //       "toast.source": "param",
      //       "toast.duration_secs": 4,
      //       "toast.maxW_pct_default": 50,
      //       "toast.maxW_pct_portrait": 80,
      //       "toast.showIcon": true,
      //       "toast.icon.assetName": "",
      //       "toast.icon.emoji": "🎉",
      //       "toast.icon.size_gu": 3,
      ...
      //       "titleSlate.enableTransition": true,
      //       "titleSlate.title": "Title slate",
      //       "titleSlate.subtitle": "Subtitle",
      ...
      //       "sidebar.shrinkVideoLayout": false,
      //       "sidebar.source": "highlightLines.items",
      //       "sidebar.padding_gu": 1.5,
      //       "sidebar.width_pct_landscape": 30,
      //       "sidebar.height_pct_portrait": 25,
      //       "sidebar.bgColor": "rgba(0, 0, 50, 0.55)",
      //       "sidebar.textColor": "rgba(255, 255, 255, 0.94)",
      //       "sidebar.fontFamily": "DMSans",
      //       "sidebar.fontWeight": "300",
      //       "sidebar.fontStyle": "",
      //       "sidebar.fontSize_gu": 1.4,
      //       "sidebar.textHighlight.color": "rgba(255, 230, 0, 1)",
      //       "sidebar.textHighlight.fontWeight": "600",
      //       "highlightLines.position": 0,
      //       "emojiReactions.source": "emojiReactions",
      //       "emojiReactions.key": 0,
      //       "emojiReactions.emoji": "",
      //       "emojiReactions.offset_x_gu": 0,
      //       "debug.showRoomState": false,
      //       "debug.overlayOpacity": 90
      //     }
      //   },
      // });
      await dailyRoom.startRecording({
