...
import type { User, UserStatistics, CreateUserData, UpdateUserData, Pagination } from "@/types";
...
export const userService = {
  ...
  getAllUsers: (params?: {
    ...
    return api.get<{ message: string; users: User[]; pagination: Pagination }>(`${API_ENDPOINTS.USERS.BASE}?${queryParams.toString()}`);
  },
